...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="pendataanbuku.php"  data-target="#collapseTwo"
...
<body>
  ...
  <div class="container">
    ...
    ?>
    <a href="Tambahbuku.php" class="btn btn-dark mb-3">Tambah ulasan</a>
          ...
          while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
              ...
              <td class="text-center">
                ...
                <a href="lihat_ulasan.php" class="btn btn-success">Lihat Ulasan</a>
              </td>
            </tr>
        <?php
          }
