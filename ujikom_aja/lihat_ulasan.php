...
// Query untuk mengambil ulasan dan nama penggunna yang memberikan ulasan
$sql = "SELECT ul.* FROM buku_ulasan INNER JOIN user  ON ul.User_ID = u.User_ID";
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php">Laporan</a>
                    </div>
                </div>
            </li>
...
<div class="row">
    ...
    // Lakukan query
    $result = $conn->query("SELECT * FROM buku_ulasan");
    if (!$result) {
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><?= $row['ulasan']; ?></p> <!-- Tampilkan ulasan -->
                    </div>
