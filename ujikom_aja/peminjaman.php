...
<body>
  ...
  <div class="container">
    ...
    ?>
    <a href="tambahpimjam.php" class="btn btn-dark mb-3">Tambah Peminjam</a>
      ...
      <tbody>
        ...
        ?>
            ...
            <td>
              ...
              <a href="delett.php?id=<?php echo $row["id"] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
            </td>
          </tr>
        <?php
        }
