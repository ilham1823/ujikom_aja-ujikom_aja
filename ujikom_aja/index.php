        ...
        <div class="container">
            ...
            <div class="row justify-content-left">
                <div class="col-md-6">
                    <form>
                        <div class="mb-3">
                            <label for="name" class="form-label">Email : perpusg@gmail.com</label>
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Alamat : Jl. Langgen no. 69</label>
                        </div>
                        <div class="mb-3">
                            <label for="pesan" class="form-label">Telepon : 0812-2319-1987</label>
                        </div>
                </div>
                </form>
            </div>
